...
export function IdeaCard({ idea, currentUserId, onIdeaDeleted }: IdeaCardProps) {
  ...
  const handleCreateInitiativeFromIdea = () => {
    openCreateInitiativeModal(`Idea: ${idea.title}\n\n${idea.description}`);
  };
    ...
    <div className={cn(
      ...
      <div className="relative z-20 flex flex-col flex-grow p-4">
        ...
        <div className="flex items-center space-x-3 mb-auto">
          <Link href={`/profile/${idea.creatorId}`} className="cursor-pointer hover:opacity-80 transition-opacity">
          ...
          <div>
            <Link href={`/profile/${idea.creatorId}`} className="cursor-pointer hover:underline">
              <p className="text-sm font-semibold">{idea.creator?.name}</p>
            </Link>
            ...
            editMode ? (
              ...
              <>
                <div className="flex-grow">
                  ...
                  <p className="text-sm whitespace-pre-wrap text-left px-2 bg-black/40 rounded-md py-1 w-fit max-w-full">{idea.description}</p>
                </div>
          ...
          <div className="space-y-3 pt-1">
            ...
            <div className="flex justify-center">
              <Button 
                ...
                onClick={handleCreateInitiativeFromIdea}
              >
