  ...
  switch (notificationType) {
    case 'DIRECT_MESSAGE':
      ...
      content = `
        ...
        <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.5; color: #666666;">${message}</p>
        ${actionUrl ? `<a href="${actionUrl}" style="display: inline-block; padding: 14px 32px; background-color: #2563eb; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 500; font-size: 16px;">${actionLabel || 'View Message'}</a>` : ''}
        <p style="margin: 30px 0 0; font-size: 14px; line-height: 1.5; color: #999999;">Reply directly on Society+ to continue the conversation.</p>
      `;
      break;
    ...
    case 'FOLLOW':
      ...
      content = `
        <h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a1a;">👥 ${title}</h1>
        <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.5; color: #666666;">${message}</p>
        ${actionUrl ? `<a href="${actionUrl}" style="display: inline-block; padding: 14px 32px; background-color: #2563eb; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 500; font-size: 16px;">${actionLabel || 'View Profile'}</a>` : ''}
      `;
      break;
    ...
    case 'INITIATIVE_INVITE':
      if (title.includes('Event')) {
        ...
        content = `
          <h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a1a;">📅 ${title}</h1>
          <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.5; color: #666666;">${message}</p>
          ${actionUrl ? `<a href="${actionUrl}" style="display: inline-block; padding: 14px 32px; background-color: #2563eb; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 500; font-size: 16px;">${actionLabel || 'View Event'}</a>` : ''}
        `;
        ...
        content = `
          <h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a1a;">🎯 ${title}</h1>
          <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.5; color: #666666;">${message}</p>
          ${actionUrl ? `<a href="${actionUrl}" style="display: inline-block; padding: 14px 32px; background-color: #2563eb; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 500; font-size: 16px;">${actionLabel || 'View Goal'}</a>` : ''}
        `;
      } else {
        ...
        content = `
          <h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a1a;">🎯 ${title}</h1>
          <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.5; color: #666666;">${message}</p>
          ${actionUrl ? `<a href="${actionUrl}" style="display: inline-block; padding: 14px 32px; background-color: #2563eb; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 500; font-size: 16px;">${actionLabel || 'View Invitation'}</a>` : ''}
        `;
      }
      break;
    ...
    case 'MILESTONE_REACHED':
      ...
      content = `
        <h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a1a;">🏆 ${title}</h1>
        <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.5; color: #666666;">${message}</p>
        ${actionUrl ? `<a href="${actionUrl}" style="display: inline-block; padding: 14px 32px; background-color: #2563eb; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 500; font-size: 16px;">${actionLabel || 'View Milestone'}</a>` : ''}
      `;
      break;
    ...
    default:
      ...
      content = `
        <h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a1a;">${title}</h1>
        <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.5; color: #666666;">${message}</p>
        ${actionUrl ? `<a href="${actionUrl}" style="display: inline-block; padding: 14px 32px; background-color: #2563eb; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 500; font-size: 16px;">${actionLabel || 'View on Society+'}</a>` : ''}
      `;
  }
