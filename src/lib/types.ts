...
> {
  ...
  actions?: Action[]; // Add this line to fix linter errors in InitiativeClientPage
}
...
export interface Initiative {
  ...
  location?: string | null; // Optional location for MVP
  progress?: number | null; // Overall progress percentage (0-100)
  societyId?: string | null; // Optional: link initiative to a society
  society?: {
    id: string;
    name: string;
    image?: string | null;
  } | null; // Optional: society information for display
}
